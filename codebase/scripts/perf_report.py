...
def _write_html(path, payload):
    ...
    html.append("<style>")
    html.append(":root{--bg:#0F1115;--card:#1B1F2A;--line:#2A2F3A;--ink:#E6EAF2;--muted:#9AA4B2;--muted2:#6B7280;--accent:#5C6BC0;--success:#22C55E;--error:#EF4444;--warning:#F59E0B}")
    html.append("body{font-family:Inter,'SF Pro Display','SF Pro Text','Helvetica Neue',sans-serif;margin:0;color:var(--ink);background:radial-gradient(1400px 800px at 18% -10%, rgba(92,107,192,.22) 0%, rgba(15,17,21,0) 55%),radial-gradient(1200px 700px at 95% 0%, rgba(245,158,11,.16) 0%, rgba(15,17,21,0) 55%),var(--bg)}")
    html.append(".wrap{max-width:1520px;margin:0 auto;padding:28px}")
    html.append(".hero{background:linear-gradient(180deg, rgba(27,31,42,.90) 0%, rgba(27,31,42,.78) 100%);border:1px solid var(--line);border-radius:16px;padding:22px;box-shadow:0 4px 20px rgba(0,0,0,.25);backdrop-filter: blur(10px)}")
    ...
    html.append(".meta{color:var(--muted2);text-align:center;margin-top:10px;font-size:13px}")
    html.append(".grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(520px,1fr));gap:16px;margin-top:20px;align-items:start}")
    html.append(".card{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:16px;box-shadow:0 4px 20px rgba(0,0,0,.25);overflow:hidden}")
    html.append(".scenario-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(340px,1fr));gap:16px;margin-top:20px}")
    html.append(".scenario-card{background:linear-gradient(180deg, rgba(27,31,42,.96) 0%, rgba(27,31,42,.80) 100%);border:1px solid var(--line);border-radius:16px;padding:18px;box-shadow:0 4px 20px rgba(0,0,0,.25)}")
    html.append(".scenario-time{font-size:34px;font-weight:800;letter-spacing:-0.02em;line-height:1.0;margin-top:10px}")
    html.append(".scenario-desc{color:var(--muted);font-size:13px;line-height:1.55;margin-top:10px}")
    html.append(".kv{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:14px}")
    html.append(".kv-box{background:rgba(15,17,21,.35);border:1px solid var(--line);border-radius:14px;padding:10px}")
    html.append(".kv-label{color:var(--muted2);font-size:11px;text-transform:uppercase;letter-spacing:.04em}")
    ...
    html.append(".error-box{margin-top:8px;padding:10px 12px;border-radius:12px;background:rgba(239,68,68,.10);border:1px solid rgba(239,68,68,.35);color:#fecaca;font-size:12px;white-space:normal;word-break:break-word}")
    ...
    html.append(".pill{display:inline-block;padding:4px 10px;border-radius:999px;background:rgba(92,107,192,.18);color:var(--ink);border:1px solid rgba(92,107,192,.35);font-size:12px}")
